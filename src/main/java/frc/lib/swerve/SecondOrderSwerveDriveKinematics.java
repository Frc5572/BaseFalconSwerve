...
public class SecondOrderSwerveDriveKinematics extends SwerveDriveKinematics {
    ...
    private final SecondOrderSwerveModuleState[] m_moduleStates;
    ...
    public SecondOrderSwerveDriveKinematics(Translation2d... wheelsMeters) {
        ...
        m_moduleStates = new SecondOrderSwerveModuleState[m_numModules];
        Arrays.fill(m_moduleStates, new SecondOrderSwerveModuleState());
     ...
     *         not normalized. Sometimes, a user input may cause one of the module speeds to go
     *         above the attainable max velocity. Use the
     *         {@link #desaturateWheelSpeeds(BetterSwerveModuleState[], double)
    ...
    public SecondOrderSwerveModuleState[] toSwerveModuleStates(ChassisSpeeds chassisSpeeds,
        ...
        accelerationVector.setColumn(0, 0, 0, 0, Math.pow(chassisSpeeds.omegaRadiansPerSecond, 2),
            0);
        ...
        for (int i = 0; i < m_numModules; i++) {
            ...
            m_moduleStates[i] = new SecondOrderSwerveModuleState(speed, angle, omega);
        }
     ...
     */
    public static void desaturateWheelSpeeds(SecondOrderSwerveModuleState[] moduleStates,
